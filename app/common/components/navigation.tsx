...
import { BarChart3Icon, BellIcon, LogOutIcon, MenuIcon, MessageCircleIcon, SettingsIcon, UserIcon } from 'lucide-react';
...
export function Navigation({
  ...
  return (
    <nav className="flex items-center justify-between px-20 h-16 bg-primary fixed top-0 left-0 right-0 z-50">
      {/* 왼쪽 메뉴 */}
