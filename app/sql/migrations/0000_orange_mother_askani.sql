CREATE TYPE "public"."declutter_situation" AS ENUM('Moving', 'Downsizing', 'Spring Cleaning', 'Digital Declutter', 'Minimalism', 'Inheritance', 'Relationship Change', 'Other');--> statement-breakpoint
CREATE TYPE "public"."environmental_impact_level" AS ENUM('Low', 'Medium', 'High', 'Critical');--> statement-breakpoint
CREATE TYPE "public"."local_tip_categories" AS ENUM('Visa', 'Bank', 'Tax', 'Health', 'Education', 'Transportation', 'Other');--> statement-breakpoint
...
CREATE TABLE "local_tip_comments" (
	"comment_id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "local_tip_comments_comment_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 1 CACHE 1),
...
CREATE TABLE "local_tip_posts" (
	...
	"location" "location" NOT NULL,
	"author" uuid NOT NULL,
	"stats" jsonb DEFAULT '{"likes":0,"comments":0,"reviews":0}'::jsonb,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "user_profiles" (
	...
	"response_rate" numeric(10, 2) DEFAULT '0.00',
...
--> statement-breakpoint
ALTER TABLE "give_and_glow_reviews" ADD CONSTRAINT "give_and_glow_reviews_product_id_products_product_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("product_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "give_and_glow_reviews" ADD CONSTRAINT "give_and_glow_reviews_giver_id_user_profiles_profile_id_fk" FOREIGN KEY ("giver_id") REFERENCES "public"."user_profiles"("profile_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "give_and_glow_reviews" ADD CONSTRAINT "give_and_glow_reviews_receiver_id_user_profiles_profile_id_fk" FOREIGN KEY ("receiver_id") REFERENCES "public"."user_profiles"("profile_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "local_business_reviews" ADD CONSTRAINT "local_business_reviews_business_id_local_businesses_id_fk" FOREIGN KEY ("business_id") REFERENCES "public"."local_businesses"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "local_business_reviews" ADD CONSTRAINT "local_business_reviews_author_user_profiles_profile_id_fk" FOREIGN KEY ("author") REFERENCES "public"."user_profiles"("profile_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "local_tip_comments" ADD CONSTRAINT "local_tip_comments_post_id_local_tip_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."local_tip_posts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "local_tip_comments" ADD CONSTRAINT "local_tip_comments_author_user_profiles_profile_id_fk" FOREIGN KEY ("author") REFERENCES "public"."user_profiles"("profile_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "local_tip_post_likes" ADD CONSTRAINT "local_tip_post_likes_user_id_user_profiles_profile_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user_profiles"("profile_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "local_tip_posts" ADD CONSTRAINT "local_tip_posts_author_user_profiles_profile_id_fk" FOREIGN KEY ("author") REFERENCES "public"."user_profiles"("profile_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_notifications" ADD CONSTRAINT "user_notifications_review_id_give_and_glow_reviews_id_fk" FOREIGN KEY ("review_id") REFERENCES "public"."give_and_glow_reviews"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
